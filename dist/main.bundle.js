...
var DashboardComponent = /** @class */ (function () {
    ...
    DashboardComponent.prototype.add = function (title, desc) {
        this.notesArray.push({ "id": this.notesArray.length + 1, "title": title, "desc": desc });
        this.title = "";
        this.desc = "";
    };
    DashboardComponent.prototype.updateNotes = function (title, desc) {
    ...
    DashboardComponent.prototype.update = function (id, title, desc) {
